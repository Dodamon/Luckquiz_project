      ...
      <div className={styles.content_answerbox}>
        <div className={styles.content_answer}>
          <div
            ...
            style={quiz.one ? { backgroundColor: "var(--select-one)" } : { backgroundColor: "var(--placeholder-text)" }}
          >
            <div>
          ...
          <div className={styles.content_input}>
            <input type="text" value={quiz.one} onChange={(e) => answerInputHandler(e, "one")} />{" "}
            <div className={styles.checkbox} style={!quiz.one ? { visibility: "hidden" } : {}}>
              {quiz.answer === "one" ? (
                <Icon
                  className={styles.keepbox}
        ...
        <div className={styles.content_answer}>
          <div
            className={styles.content_color}
            style={quiz.two ? { backgroundColor: "var(--select-two)" } : { backgroundColor: "var(--placeholder-text)" }}
          >
            <div>
          ...
          <div className={styles.content_input}>
            <input type="text" value={quiz.two} onChange={(e) => answerInputHandler(e, "two")} />{" "}
            <div className={styles.checkbox} style={!quiz.two ? { visibility: "hidden" } : {}}>
              {quiz.answer === "two" ? (
                <Icon
                  className={styles.keepbox}
                  icon="fluent-emoji-flat:check-mark-button"
        ...
        <div className={styles.content_answer}>
          <div
            className={styles.content_color}
            style={
              quiz.three ? { backgroundColor: "var(--select-three)" } : { backgroundColor: "var(--placeholder-text)" }
            }
          >
            <div>
              <Icon icon="ph:x-bold" />
          ...
          <div className={styles.content_input}>
            <input type="text" value={quiz.three} onChange={(e) => answerInputHandler(e, "three")} />{" "}
            <div className={styles.checkbox} style={!quiz.three ? { visibility: "hidden" } : {}}>
              {quiz.answer === "three" ? (
                <Icon
                  className={styles.keepbox}
                  icon="fluent-emoji-flat:check-mark-button"
        ...
        <div className={styles.content_answer}>
          <div
            className={styles.content_color}
            style={
              quiz.four ? { backgroundColor: "var(--select-four)" } : { backgroundColor: "var(--placeholder-text)" }
            }
          >
            <div>
          ...
          <div className={styles.content_input}>
            <input type="text" value={quiz.four} onChange={(e) => answerInputHandler(e, "four")} />{" "}
            <div className={styles.checkbox} style={!quiz.four ? { visibility: "hidden" } : {}}>
              {quiz.answer === "four" ? (
                <Icon
                  className={styles.keepbox}
                  icon="fluent-emoji-flat:check-mark-button"
